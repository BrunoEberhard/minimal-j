...
public abstract class DbSyntax {
	...
	protected void addIdColumn(StringBuilder s, boolean big) {
		s.append(" id ");
		s.append(big ? "BIGINT" : "INT");
	...
	public static class DerbyDbSyntax extends DbSyntax {
		...
		protected void addIdColumn(StringBuilder s, boolean big) {
			s.append(" id ");
			s.append(big ? "BIGINT" : "INT");
			s.append(" NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1)");
		}
