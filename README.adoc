 ...
 * Current released version: [![Maven Central](https://maven-badges.herokuapp.com/maven-central/org.minimalj/minimalj/badge.svg)](https://maven-badges.herokuapp.com/maven-central/org.minimalj/minimalj)
 * Build status: [![Build Status](https://api.travis-ci.org/BrunoEberhard/minimal-j.png)](https://travis-ci.org/BrunoEberhard/minimal-j)
