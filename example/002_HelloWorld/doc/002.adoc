...
There are only three classes of IContent: Forms, Tables and HTML. A Text is not a IContent but a IComponent. 
That is the reason why the 'Hello World' Text must be put in a form and cannot be
