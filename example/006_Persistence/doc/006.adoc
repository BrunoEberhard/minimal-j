...
==== Read by Predicate
(TODO complete after decide if Predicates are renamed to Criteria (again))

This is the best way to read objects depending on thier fields. The most frequent use of this is probably when you want
