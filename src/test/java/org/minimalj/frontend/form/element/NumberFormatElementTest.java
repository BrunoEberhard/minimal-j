...
import org.minimalj.model.annotation.Negative;
...
public class NumberFormatElementTest {
	...
	public void testNegativeInteger() {
		IntegerFormElement element = new IntegerFormElement(Keys.getProperty(TestNumbers.$.aNegativeInteger), true);
		Assert.assertEquals((Integer) 123, element.parse("123"));
	...
	public void testNegativeIntegerOfSize3() {
		IntegerFormElement element = new IntegerFormElement(Keys.getProperty(TestNumbers.$.aNegativeIntegerOfSize3), true);
		Assert.assertEquals((Integer) 123, element.parse("123"));
		Assert.assertEquals(Integer.valueOf(-3), element.parse("-3"));
	...
	public void testNegativeLong() {
		LongFormElement element = new LongFormElement(Keys.getProperty(TestNumbers.$.aNegativeLong), true);
		Assert.assertEquals((Long) 123L, element.parse("123"));
	...
	public void testNegativeLongOfSize3() {
		LongFormElement element = new LongFormElement(Keys.getProperty(TestNumbers.$.aNegativeLongOfSize3), true);
		Assert.assertEquals((Long) 123L, element.parse("123"));
		Assert.assertEquals(Long.valueOf(-3), element.parse("-3"));
		Assert.assertTrue("Values larger than size 3 should be invalid", InvalidValues.isInvalid(element.parse("1234")));
	}
	...
	public void testNegativeBigDecimal() {
		BigDecimalFormElement element = new BigDecimalFormElement(Keys.getProperty(TestNumbers.$.aNegativeBigDecimal), true);
		Assert.assertTrue(BigDecimal.valueOf(123).compareTo(element.parse("123")) == 0);
	...
	public static class TestNumbers {
		...
		@Negative
		public Integer aNegativeInteger;

		@Size(3) @Negative
		public Integer aNegativeIntegerOfSize3;

		
		public Long aLong;
		
		@Negative
		public Long aNegativeLong;

		@Size(3) @Negative
		public Long aNegativeLongOfSize3;


		public BigDecimal aBigDecimal;

		@Negative
		public BigDecimal aNegativeBigDecimal;
